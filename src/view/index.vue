...
<p>备案号：<a class="beian" style="color:red;display:inline;" href="http://beian.miit.gov.cn">粤ICP备13069893号</a></p>
  <p>Copyright © 2009-2020，www.kalaplay.com<br/>版权所有 © 广州丰谱信息技术有限公司 未经许可 严禁复制</p>
    </footer>
...
export default {
  ...
  data () {
    return {
      waveShow: [false, false, false, false, false, false],
      nowIndex: 0,
      pages: [
         {
          path: '/knowledge',
          img: require('../assets/images/homePage/btn_know.png')
        },{
          path: '/personal',
  ...
  methods: {
    toPage (path, index) {
      var waveShow = [false, false, false, false, false, false]
      waveShow[index] = true
      this.waveShow = waveShow
      var that = this
      setTimeout(() => {
        that.waveShow = [false, false, false, false, false, false]
...
.wrap-bg {
  ...
  /* top: 45px; */
  display: block;
  background: url("../assets/images/homePage/blue.jpg");
...
.wavebg-0 {
  background: url("../assets/images/homePage/btn_know.png");
...
.wave3 {
  z-index: 5;
  background-size: 41vw 41vw;
  animation: w 1s 0.6s forwards;
  opacity: 0;
}
.wave4 {
  z-index: 6;
